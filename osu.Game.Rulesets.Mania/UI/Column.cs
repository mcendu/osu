...
namespace osu.Game.Rulesets.Mania.UI
{
    ...
    public class Column : ScrollingPlayfield, IKeyBindingHandler<ManiaAction>, IHasAccentColour
    {
        ...
        internal void OnNewResult(DrawableHitObject judgedObject, JudgementResult result)
        {
            ...
            hitObjectArea.Explosions.Add(new SkinnableDrawable(new ManiaSkinComponent(ManiaSkinComponents.HitExplosion),
                _ => new DefaultHitExplosion(judgedObject.AccentColour.Value, judgedObject is DrawableHoldNoteTick))
            {
